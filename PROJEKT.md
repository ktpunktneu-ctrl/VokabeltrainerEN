...
- `sw.js` (`static/` + `docs/`, Version -> `vokabelen-v25`): die 6 neuen Assets in `ASSETS` aufgenommen, damit sie beim ersten Besuch vorgecacht werden (echte Offline-Faehigkeit ab dem ersten App-Start, nicht erst nach dem ersten Online-OCR-Versuch).
